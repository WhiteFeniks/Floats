...
int		main(void)
{
   ...
   // i = ft_printf("lib точность =   ,      10999.9999979 = %.f\n", 10999.9999979);
 ...
 //   i = ft_printf("lib точность =  2,      10999.9999979 = %.2f\n", 10999.9999979);
    printf("lib точность =  3,      10999.9999979 = %.3f\n", 10999.9999979);
    i = ft_printf("lib точность =  3,      10999.9999979 = %.3f\n", 10999.9999979);
    printf("lib точность =  4,      10999.9999979 = %.4f\n", 10999.9999979);
    i = ft_printf("lib точность =  4,      10999.9999979 = %.4f\n", 10999.9999979);
    printf("lib точность =  6,      10999.9999979 = %.6f\n", 10999.9999979);
    i = ft_printf("lib точность =  6,      10999.9999979 = %.6f\n", 10999.9999979);
    printf("lib точность =  7,      10999.9999979 = %.7f\n", 10999.9999979);
    i = ft_printf("lib точность =  7,      10999.9999979 = %.7f\n", 10999.9999979);
    printf("lib точность =  8,      10999.9999979 = %.8f\n", 10999.9999979);
    i = ft_printf("lib точность =  8,      10999.9999979 = %.8f\n", 10999.9999979);
    printf("lib точность =  9,      10999.9999979 = %.9f\n", 10999.9999979);
    i = ft_printf("lib точность =  9,      10999.9999979 = %.9f\n", 10999.9999979);
    printf("lib точность = 10,      10999.9999979 = %.10f\n", 10999.9999979);
    i = ft_printf("lib точность = 10,      10999.9999979 = %.10f\n", 10999.9999979);
    printf("lib точность = 11,      10999.9999979 = %11f\n", 10999.9999979);
    i = ft_printf("lib точность = 11,      10999.9999979 = %11f\n", 10999.9999979);
    printf("lib точность = 12,      10999.9999979 = %.12f\n", 10999.9999979);
    i = ft_printf("lib точность = 12,      10999.9999979 = %.12f\n", 10999.9999979);
    printf("lib точность = 13,      10999.9999979 = %.13f\n", 10999.9999979);
    i = ft_printf("lib точность = 13,      10999.9999979 = %.13f\n", 10999.9999979);
